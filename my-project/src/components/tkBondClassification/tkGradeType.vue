<template>
    <div>
        ...
        <div class="clearfix">
            <p class="fl fs14 tk-grade-name">评级</p>
            <span class="fl fs15 tk-grade-val">{{ rateFormer }}</span>
        </div>
...
export default {
    ...
    methods: {
        transmitParam(parames) {
            const that = this;
            that.rateFormer = parames.rateFormer;
